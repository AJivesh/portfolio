      ...
      <div className="projects">
        <div className="single">
          <div className="single-img">
            <img
              src="https://ik.imagekit.io/jivesharya/Screenshot_2023-06-10_154012.png?updatedAt=1686391847803"
              alt=""
            />
          </div>
          <div className="single-detail">
            <h4>Tin Dog</h4>
            <p>
              An interactive UI for a conceptualized dating application for
              dogs, built to responsive on all devices.
            </p>
            <div class="button-wrap">
              <a
                target="_blank"
                href="https://ajivesh.github.io/TinDog/"
                class="button"
              >
                Visit &rarr;
              </a>
        ...
        <div className="single reverse">
          <div className="single-img">
            <img
              src="https://ik.imagekit.io/jivesharya/Screenshot_2023-06-10_153600.png?updatedAt=1686391760729"
              alt=""
            />
          </div>
          <div className="single-detail">
            <h4>Drum Kit</h4>
            <p>An application to play drum using your keyboard.</p>
            <div class="button-wrap">
        ...
        <div className="single">
          <div className="single-img">
            <img
              src="https://ik.imagekit.io/jivesharya/Screenshot_2023-06-10_153511.png?updatedAt=1686391760485"
              alt=""
            />
          </div>
          <div className="single-detail">
            <h4>Dice</h4>
            <p>A simple dice game built using HTML, CSS and JavaScript.</p>
            <div class="button-wrap">
              <button class="button">Visit &rarr;</button>
            </div>
          </div>
