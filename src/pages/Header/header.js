      ...
      <div className="menu-toggle">
        ...
        <div className="navigation" ref={elSocials}>
          <div className="large_menu">
            ...
            <a
              className="linkedin"
              href="https://www.linkedin.com/in/jivesh-arya-293327230/"
              target="_blank"
            >
            ...
            <a
              className="twitter"
              href="https://www.instagram.com/jivesh9/"
              target="_blank"
            >
            ...
            <a
              className="schedule"
              href="https://calendly.com/jivesh-arya"
              target="_blank"
            >
          ...
          <div className="small_menu">
            <ul>
              ...
              <li className="menu-four">
                <a
                  className="nav-link"
                  href="https://ik.imagekit.io/jivesharya/Jivesh_Arya.pdf?updatedAt=1686392853595"
                  target="_blank"
                  rel="noreferrer"
                >
                  Resume
              ...
              <li className="menu-five">
                <a
                  className="nav-link"
                  href="mailto:jivesh.arya@gmail.com"
                  target="_blank"
                  rel="noreferrer"
                >
                  Contact
